...
CharacterVoiceCard.displayName = 'CharacterVoiceCard'
...
export const AudioSection = () => {
  ...
  const [dubbingListMounted, setDubbingListMounted] = useState(false)
    ...
    return uniqueCharacterNames.map((characterName) => {
      ...
      return (
        <CharacterVoiceCard
          ...
          openVoiceSelectionModal={openVoiceSelectionModal}
        />
      )
    })

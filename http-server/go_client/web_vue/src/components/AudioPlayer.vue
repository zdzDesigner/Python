        ...
        <div class="max-w-3xl mx-auto animate-fade-in">
          <div class="bg-white rounded-2xl shadow-xl overflow-hidden ring-1 ring-slate-200/50">
            <div class="p-6 bg-gradient-to-br from-indigo-500 to-purple-600 text-white text-center">
              ...
              <h3 class="font-bold text-xl truncate" :title="selectedFile.name">
            ...
            <div class="p-6">
              ...
              <div class="space-y-4">
                <div class="bg-slate-50/80 p-4 rounded-lg ring-1 ring-slate-200/50">
                  ...
                  <div class="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p class="font-medium text-slate-800">{{ selectedFile.name.split('/').pop() }}</p>
                    </div>
                    <div>
                      <p class="text-xs text-slate-500">Type</p>
                      <p class="font-medium text-slate-800">{{ selectedFile.name.split('.').pop().toUpperCase() }}</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="bg-slate-50/80 p-4 rounded-lg ring-1 ring-slate-200/50">
                  ...
                  <p class="font-mono text-xs break-all bg-white p-3 rounded border border-slate-200">{{ selectedFile.path }}</p>
                </div>
              </div>
            </div>
          </div>
...
const emit = defineEmits(['playbackComplete', 'pauseRequested'])

<template>
  <div>
    <div style="padding: 10px">
      ...
      <a-button type="primary" style="margin-left: 10px" @click="handleBatchTrain">
        批量训练
      </a-button>
    </div>
    ...
    <a-modal
      title="角色配音"
      v-model:open="isMappingModalVisible"
      @ok="handleModalOk"
    ...
    >
      <div style="max-height: 400px; overflow-y: auto">
        <div
          v-for="characterName in uniqueCharacterNames"
          :key="characterName"
        ...
        >
          ...
          <div style="flex: 2; margin-left: 20px">
            <a-select
              style="width: 100%"
              placeholder="选择音频文件"
              v-model:value="characterMappings[characterName]"
              allow-clear
              virtual
            >
    ...
    <TTSTable
      ...
      @train="handleTrain"
      @play="handlePlay"
      @dubbing-change="handleDubbingChange"
    />
  </div>
</template>
...
import TTSTable from './TTSTable.vue'
...
const emit = defineEmits(['synthesizeComplete'])
